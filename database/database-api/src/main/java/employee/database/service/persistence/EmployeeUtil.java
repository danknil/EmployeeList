...
public class EmployeeUtil {
	...
	public static Employee findByUuid_First(
		...
		throws employee.database.exception.NoSuchEmployeeException {
	 ...
	 * @return the matching employees
	 */
	public static List<Employee> findBypositionType(long position) {
		return getPersistence().findBypositionType(position);
	}
	 ...
	 * @return the range of matching employees
	 */
	public static List<Employee> findBypositionType(
		long position, int start, int end) {

		return getPersistence().findBypositionType(position, start, end);
	}
	...
	public static List<Employee> findBypositionType(
		...
		return getPersistence().findBypositionType(
	 ...
	 * @throws NoSuchEmployeeException if a matching employee could not be found
	 */
	public static Employee findBypositionType_First(
			long position, OrderByComparator<Employee> orderByComparator)
		throws employee.database.exception.NoSuchEmployeeException {

		return getPersistence().findBypositionType_First(
	 ...
	 * @return the first matching employee, or <code>null</code> if a matching employee could not be found
	 */
	public static Employee fetchBypositionType_First(
		long position, OrderByComparator<Employee> orderByComparator) {

		return getPersistence().fetchBypositionType_First(
			position, orderByComparator);
	}
	 ...
	 * @throws NoSuchEmployeeException if a matching employee could not be found
	 */
	public static Employee findBypositionType_Last(
			long position, OrderByComparator<Employee> orderByComparator)
		throws employee.database.exception.NoSuchEmployeeException {

		return getPersistence().findBypositionType_Last(
			position, orderByComparator);
	}
	 ...
	 * @return the last matching employee, or <code>null</code> if a matching employee could not be found
	 */
	public static Employee fetchBypositionType_Last(
		long position, OrderByComparator<Employee> orderByComparator) {

		return getPersistence().fetchBypositionType_Last(
			position, orderByComparator);
	}
	 ...
	 * @throws NoSuchEmployeeException if a employee with the primary key could not be found
	 */
	public static Employee[] findBypositionType_PrevAndNext(
			long id, long position,
			OrderByComparator<Employee> orderByComparator)
		throws employee.database.exception.NoSuchEmployeeException {

		return getPersistence().findBypositionType_PrevAndNext(
			id, position, orderByComparator);
	}
	 ...
	 * @param position the position
	 */
	public static void removeBypositionType(long position) {
		getPersistence().removeBypositionType(position);
	}
	 ...
	 * @return the number of matching employees
	 */
	public static int countBypositionType(long position) {
		return getPersistence().countBypositionType(position);
	}
