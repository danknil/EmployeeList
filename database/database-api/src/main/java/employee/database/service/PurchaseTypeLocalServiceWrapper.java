...
public class PurchaseTypeLocalServiceWrapper
	 ...
	 */
	@Override
	public employee.database.model.PurchaseType addPurchaseType(
		employee.database.model.PurchaseType purchaseType) {
	 ...
	 */
	@Override
	public employee.database.model.PurchaseType createPurchaseType(long id) {
	 ...
	 */
	@Override
	public employee.database.model.PurchaseType deletePurchaseType(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public employee.database.model.PurchaseType deletePurchaseType(
		employee.database.model.PurchaseType purchaseType) {
	...
	@Override
	public employee.database.model.PurchaseType fetchPurchaseType(long id) {
		return _purchaseTypeLocalService.fetchPurchaseType(id);
	}

	@Override
	public void fromCSV(java.io.InputStream inputStream) {
		_purchaseTypeLocalService.fromCSV(inputStream);
	}
	 ...
	 */
	@Override
	public employee.database.model.PurchaseType getPurchaseType(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<employee.database.model.PurchaseType>
	 ...
	 */
	@Override
	public employee.database.model.PurchaseType updatePurchaseType(
		employee.database.model.PurchaseType purchaseType) {
