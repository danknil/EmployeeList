...
public class EmployeeLocalServiceWrapper
	 ...
	 */
	@Override
	public employee.database.model.Employee addEmployee(
		employee.database.model.Employee employee) {
	 ...
	 */
	@Override
	public employee.database.model.Employee createEmployee(long id) {
	 ...
	 */
	@Override
	public employee.database.model.Employee deleteEmployee(
		employee.database.model.Employee employee) {
	 ...
	 */
	@Override
	public employee.database.model.Employee deleteEmployee(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public employee.database.model.Employee fetchEmployee(long id) {
	...
	public void fromCSV(java.io.InputStream inputStream)
		...
		_employeeLocalService.fromCSV(inputStream);
	}
	 ...
	 */
	@Override
	public employee.database.model.Employee getEmployee(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<employee.database.model.Employee> getEmployees(
		int start, int end) {
	 ...
	 */
	@Override
	public employee.database.model.Employee updateEmployee(
		employee.database.model.Employee employee) {
