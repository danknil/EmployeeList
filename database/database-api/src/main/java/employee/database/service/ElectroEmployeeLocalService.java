...
public interface ElectroEmployeeLocalService
	...
	public ElectroEmployee createElectroEmployee(long employeeId);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ElectroEmployee deleteElectroEmployee(long employeeId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ElectroEmployee fetchElectroEmployee(long employeeId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ElectroEmployee getElectroEmployee(long employeeId)
		throws PortalException;
