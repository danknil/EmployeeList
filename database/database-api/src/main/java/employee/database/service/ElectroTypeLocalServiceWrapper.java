...
public class ElectroTypeLocalServiceWrapper
	 ...
	 */
	@Override
	public employee.database.model.ElectroType addElectroType(
		employee.database.model.ElectroType electroType) {
	 ...
	 */
	@Override
	public employee.database.model.ElectroType createElectroType(long id) {
	 ...
	 */
	@Override
	public employee.database.model.ElectroType deleteElectroType(
		employee.database.model.ElectroType electroType) {
	 ...
	 */
	@Override
	public employee.database.model.ElectroType deleteElectroType(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public employee.database.model.ElectroType fetchElectroType(long id) {
		return _electroTypeLocalService.fetchElectroType(id);
	}

	@Override
	public void fromCSV(java.io.InputStream inputStream) {
		_electroTypeLocalService.fromCSV(inputStream);
	}
	 ...
	 */
	@Override
	public employee.database.model.ElectroType getElectroType(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<employee.database.model.ElectroType> getElectroTypes(
		int start, int end) {
	 ...
	 */
	@Override
	public employee.database.model.ElectroType updateElectroType(
		employee.database.model.ElectroType electroType) {
