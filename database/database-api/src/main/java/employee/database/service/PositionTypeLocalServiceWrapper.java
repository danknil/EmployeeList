...
public class PositionTypeLocalServiceWrapper
	 ...
	 */
	@Override
	public employee.database.model.PositionType addPositionType(
		employee.database.model.PositionType positionType) {
	 ...
	 */
	@Override
	public employee.database.model.PositionType createPositionType(long id) {
	 ...
	 */
	@Override
	public employee.database.model.PositionType deletePositionType(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public employee.database.model.PositionType deletePositionType(
		employee.database.model.PositionType positionType) {
	...
	@Override
	public employee.database.model.PositionType fetchPositionType(long id) {
	...
	public void fromCSV(java.io.InputStream inputStream)
		...
		_positionTypeLocalService.fromCSV(inputStream);
	}
	 ...
	 */
	@Override
	public employee.database.model.PositionType getPositionType(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<employee.database.model.PositionType>
	 ...
	 */
	@Override
	public employee.database.model.PositionType updatePositionType(
		employee.database.model.PositionType positionType) {
