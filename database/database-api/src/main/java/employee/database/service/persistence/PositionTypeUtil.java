...
/**
 * The persistence utility for the position type service. This utility wraps <code>employee.database.service.persistence.impl.PositionTypePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class PositionTypeUtil {
	...
	public static PositionType findByUuid_First(
		...
		throws employee.database.exception.NoSuchPositionTypeException {
