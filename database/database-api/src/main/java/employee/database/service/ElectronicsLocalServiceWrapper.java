...
public class ElectronicsLocalServiceWrapper
	 ...
	 */
	@Override
	public employee.database.model.Electronics addElectronics(
		employee.database.model.Electronics electronics) {
	 ...
	 */
	@Override
	public employee.database.model.Electronics createElectronics(long id) {
	 ...
	 */
	@Override
	public employee.database.model.Electronics deleteElectronics(
		employee.database.model.Electronics electronics) {
	 ...
	 */
	@Override
	public employee.database.model.Electronics deleteElectronics(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public employee.database.model.Electronics fetchElectronics(long id) {
		return _electronicsLocalService.fetchElectronics(id);
	}

	@Override
	public void fromCSV(java.io.InputStream inputStream) {
		_electronicsLocalService.fromCSV(inputStream);
	}
	 ...
	 */
	@Override
	public employee.database.model.Electronics getElectronics(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<employee.database.model.Electronics> getElectronicses(
		int start, int end) {
	 ...
	 */
	@Override
	public employee.database.model.Electronics updateElectronics(
		employee.database.model.Electronics electronics) {
