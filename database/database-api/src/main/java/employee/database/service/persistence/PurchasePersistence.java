...
public interface PurchasePersistence extends BasePersistence<Purchase> {
	 ...
	 * @return the matching purchases
	 */
	public java.util.List<Purchase> findByelectronics(long electroId);
	 ...
	 * @return the range of matching purchases
	 */
	public java.util.List<Purchase> findByelectronics(
	 ...
	 * @return the matching purchases
	 */
	public java.util.List<Purchase> findBypurchaseType(long type);
	 ...
	 * @return the range of matching purchases
	 */
	public java.util.List<Purchase> findBypurchaseType(
