...
public class EmployeePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newEmployee.setPosition(RandomTestUtil.nextLong());
		...
		Assert.assertEquals(
			existingEmployee.getPosition(), newEmployee.getPosition());
		Assert.assertEquals(
	...
	@Test
	public void testCountBypositionType() throws Exception {
		_persistence.countBypositionType(RandomTestUtil.nextLong());

		_persistence.countBypositionType(0L);
	}
	...
	protected OrderByComparator<Employee> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"EmployeeList_Employee", "uuid", true, "id", true, "lastname", true,
			"firstname", true, "patronymic", true, "birthdate", true,
			"position", true, "gender", true);
	}
	...
	protected Employee addEmployee() throws Exception {
		...
		employee.setPosition(RandomTestUtil.nextLong());
