...
import employee.database.service.ElectroEmployeeLocalServiceUtil;
...
public class ElectroEmployeePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newElectroEmployee.setUuid(RandomTestUtil.randomString());

		newElectroEmployee.setEtype(RandomTestUtil.nextLong());
		...
		Assert.assertEquals(
			existingElectroEmployee.getUuid(), newElectroEmployee.getUuid());
		Assert.assertEquals(
			existingElectroEmployee.getEmployeeId(),
			newElectroEmployee.getEmployeeId());
		Assert.assertEquals(
			existingElectroEmployee.getEtype(), newElectroEmployee.getEtype());
	}
	...
	protected OrderByComparator<ElectroEmployee> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"EmployeeList_ElectroEmployee", "uuid", true, "employeeId", true,
			"etype", true);
	}
	...
	public void testDynamicQueryByPrimaryKeyExisting() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq(
				"employeeId", newElectroEmployee.getEmployeeId()));
	...
	protected ElectroEmployee addElectroEmployee() throws Exception {
		...
		electroEmployee.setUuid(RandomTestUtil.randomString());

		electroEmployee.setEtype(RandomTestUtil.nextLong());
