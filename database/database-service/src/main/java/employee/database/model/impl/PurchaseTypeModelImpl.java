...
import employee.database.model.PurchaseTypeModel;
import employee.database.model.PurchaseTypeSoap;
...
/**
 * The base model implementation for the PurchaseType service. Represents a row in the &quot;EmployeeList_PurchaseType&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class PurchaseTypeModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "EmployeeList_PurchaseType";
	...
	public static final String TABLE_SQL_CREATE =
		"create table EmployeeList_PurchaseType (uuid_ VARCHAR(75) null,id_ LONG not null primary key,name VARCHAR(100) null)";

	public static final String TABLE_SQL_DROP =
		"drop table EmployeeList_PurchaseType";

	public static final String ORDER_BY_JPQL = " ORDER BY purchaseType.id ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY EmployeeList_PurchaseType.id_ ASC";
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(
		employee.database.service.util.ServiceProps.get(
			"lock.expiration.time.employee.database.model.PurchaseType"));
