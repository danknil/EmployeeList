...
import employee.database.model.PurchaseModel;
import employee.database.model.PurchaseSoap;
...
/**
 * The base model implementation for the Purchase service. Represents a row in the &quot;EmployeeList_Purchase&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class PurchaseModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "EmployeeList_Purchase";

	public static final Object[][] TABLE_COLUMNS = {
		{"uuid_", Types.VARCHAR}, {"id_", Types.BIGINT},
		{"electroId", Types.BIGINT}, {"employeeId", Types.BIGINT},
		{"purchaseDate", Types.TIMESTAMP}, {"type_", Types.BIGINT}
	};
	...
	public static final String TABLE_SQL_CREATE =
		"create table EmployeeList_Purchase (uuid_ VARCHAR(75) null,id_ LONG not null primary key,electroId LONG,employeeId LONG,purchaseDate DATE null,type_ LONG)";

	public static final String TABLE_SQL_DROP =
		"drop table EmployeeList_Purchase";

	public static final String ORDER_BY_JPQL = " ORDER BY purchase.id ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY EmployeeList_Purchase.id_ ASC";
	 ...
	 */
	@Deprecated
	public static final long ELECTROID_COLUMN_BITMASK = 1L;
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(
		employee.database.service.util.ServiceProps.get(
			"lock.expiration.time.employee.database.model.Purchase"));
	...
	static {
		...
		attributeGetterFunctions.put("type", Purchase::getType);
	...
	static {
		...
		attributeSetterBiConsumers.put(
			"type", (BiConsumer<Purchase, Long>)Purchase::setType);
	 ...
	 */
	@Deprecated
	public long getOriginalElectroId() {
		return GetterUtil.getLong(
			this.<Long>getColumnOriginalValue("electroId"));
	}
	...
	static {
		...
		columnBitmasks.put("electroId", 4L);
