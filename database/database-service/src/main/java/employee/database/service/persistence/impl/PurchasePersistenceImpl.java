...
import employee.database.model.impl.PurchaseImpl;
import employee.database.model.impl.PurchaseModelImpl;
...
public class PurchasePersistenceImpl
	...
	public Purchase[] findByUuid_PrevAndNext(
		...
		Purchase purchase = findByPrimaryKey(id);
	...
	private FinderPath _finderPathWithPaginationFindByelectronics;
	private FinderPath _finderPathWithoutPaginationFindByelectronics;
	private FinderPath _finderPathCountByelectronics;
	 ...
	 */
	@Override
	public List<Purchase> findByelectronics(long electroId) {
		return findByelectronics(
			electroId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<Purchase> findByelectronics(
		long electroId, int start, int end) {

		return findByelectronics(electroId, start, end, null);
	}
	...
	public List<Purchase> findByelectronics(
		...
		return findByelectronics(
			electroId, start, end, orderByComparator, true);
	}
	...
	public List<Purchase> findByelectronics(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByelectronics;
				finderArgs = new Object[] {electroId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByelectronics;
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Purchase purchase : list) {
					if (electroId != purchase.getElectroId()) {
						list = null;
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_ELECTRONICS_ELECTROID_2);
	 ...
	 */
	@Override
	public Purchase findByelectronics_First(
			long electroId, OrderByComparator<Purchase> orderByComparator)
		throws NoSuchPurchaseException {

		Purchase purchase = fetchByelectronics_First(
	 ...
	 */
	@Override
	public Purchase fetchByelectronics_First(
		long electroId, OrderByComparator<Purchase> orderByComparator) {

		List<Purchase> list = findByelectronics(
			electroId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Purchase findByelectronics_Last(
			long electroId, OrderByComparator<Purchase> orderByComparator)
		throws NoSuchPurchaseException {

		Purchase purchase = fetchByelectronics_Last(
			electroId, orderByComparator);
	 ...
	 */
	@Override
	public Purchase fetchByelectronics_Last(
		long electroId, OrderByComparator<Purchase> orderByComparator) {

		int count = countByelectronics(electroId);
		...
		List<Purchase> list = findByelectronics(
			electroId, count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public Purchase[] findByelectronics_PrevAndNext(
		...
		try {
			...
			array[0] = getByelectronics_PrevAndNext(
				session, purchase, electroId, orderByComparator, true);

			array[1] = purchase;

			array[2] = getByelectronics_PrevAndNext(
				session, purchase, electroId, orderByComparator, false);
	...
	protected Purchase getByelectronics_PrevAndNext(
		Session session, Purchase purchase, long electroId,
		OrderByComparator<Purchase> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public void removeByelectronics(long electroId) {
		for (Purchase purchase :
				findByelectronics(
					electroId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
	 ...
	 */
	@Override
	public int countByelectronics(long electroId) {
		FinderPath finderPath = _finderPathCountByelectronics;

		Object[] finderArgs = new Object[] {electroId};
	...
	private static final String _FINDER_COLUMN_ELECTRONICS_ELECTROID_2 =
		"purchase.electroId = ?";
	...
	private FinderPath _finderPathWithPaginationFindBypurchaseType;
	private FinderPath _finderPathWithoutPaginationFindBypurchaseType;
	private FinderPath _finderPathCountBypurchaseType;
	 ...
	 */
	@Override
	public List<Purchase> findBypurchaseType(long type) {
		return findBypurchaseType(
	 ...
	 */
	@Override
	public List<Purchase> findBypurchaseType(long type, int start, int end) {
		return findBypurchaseType(type, start, end, null);
	}
	 ...
	 */
	@Override
	public List<Purchase> findBypurchaseType(
		long type, int start, int end,
		OrderByComparator<Purchase> orderByComparator) {

		return findBypurchaseType(type, start, end, orderByComparator, true);
	}
	...
	public List<Purchase> findBypurchaseType(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindBypurchaseType;
				finderArgs = new Object[] {type};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindBypurchaseType;
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_PURCHASETYPE_TYPE_2);
	 ...
	 */
	@Override
	public Purchase findBypurchaseType_First(
			long type, OrderByComparator<Purchase> orderByComparator)
		throws NoSuchPurchaseException {

		Purchase purchase = fetchBypurchaseType_First(type, orderByComparator);
	 ...
	 */
	@Override
	public Purchase fetchBypurchaseType_First(
		long type, OrderByComparator<Purchase> orderByComparator) {

		List<Purchase> list = findBypurchaseType(type, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Purchase findBypurchaseType_Last(
			long type, OrderByComparator<Purchase> orderByComparator)
		throws NoSuchPurchaseException {

		Purchase purchase = fetchBypurchaseType_Last(type, orderByComparator);
	 ...
	 */
	@Override
	public Purchase fetchBypurchaseType_Last(
		long type, OrderByComparator<Purchase> orderByComparator) {

		int count = countBypurchaseType(type);

		if (count == 0) {
			return null;
		}

		List<Purchase> list = findBypurchaseType(
	 ...
	 */
	@Override
	public Purchase[] findBypurchaseType_PrevAndNext(
		...
		try {
			...
			array[0] = getBypurchaseType_PrevAndNext(
				session, purchase, type, orderByComparator, true);

			array[1] = purchase;

			array[2] = getBypurchaseType_PrevAndNext(
				session, purchase, type, orderByComparator, false);
	...
	protected Purchase getBypurchaseType_PrevAndNext(
		Session session, Purchase purchase, long type,
		OrderByComparator<Purchase> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public void removeBypurchaseType(long type) {
		for (Purchase purchase :
				findBypurchaseType(
					type, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
	 ...
	 */
	@Override
	public int countBypurchaseType(long type) {
		FinderPath finderPath = _finderPathCountBypurchaseType;
	...
	private static final String _FINDER_COLUMN_PURCHASETYPE_TYPE_2 =
		"purchase.type = ?";
	...
	public void afterPropertiesSet() {
		Bundle bundle = FrameworkUtil.getBundle(PurchasePersistenceImpl.class);
		...
		_finderPathWithPaginationFindByelectronics = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByelectronics",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"electroId"}, true);

		_finderPathWithoutPaginationFindByelectronics = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByelectronics",
			new String[] {Long.class.getName()}, new String[] {"electroId"},
			true);

		_finderPathCountByelectronics = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByelectronics",
			new String[] {Long.class.getName()}, new String[] {"electroId"},
			false);
		...
		_finderPathWithPaginationFindBypurchaseType = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findBypurchaseType",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
		...
		_finderPathWithoutPaginationFindBypurchaseType = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findBypurchaseType",
			new String[] {Long.class.getName()}, new String[] {"type_"}, true);

		_finderPathCountBypurchaseType = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countBypurchaseType",
