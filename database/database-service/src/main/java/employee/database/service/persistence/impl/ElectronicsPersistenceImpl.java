...
import employee.database.model.impl.ElectronicsImpl;
import employee.database.model.impl.ElectronicsModelImpl;
...
public class ElectronicsPersistenceImpl
	 ...
	 */
	@Override
	public List<Electronics> findByelectroType(long etype) {
	 ...
	 */
	@Override
	public List<Electronics> findByelectroType(long etype, int start, int end) {
	...
	public Electronics findByelectroType_First(
			long etype, OrderByComparator<Electronics> orderByComparator)
		throws NoSuchElectronicsException {
	...
	public Electronics[] findByelectroType_PrevAndNext(
		...
		try {
			...
			array[0] = getByelectroType_PrevAndNext(
				session, electronics, etype, orderByComparator, true);

			array[1] = electronics;

			array[2] = getByelectroType_PrevAndNext(
				session, electronics, etype, orderByComparator, false);
	...
	protected Electronics getByelectroType_PrevAndNext(
		Session session, Electronics electronics, long etype,
		OrderByComparator<Electronics> orderByComparator, boolean previous) {
