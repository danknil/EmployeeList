...
import employee.database.exception.NoSuchEmployeeException;
import employee.database.model.Employee;
import employee.database.model.impl.EmployeeImpl;
import employee.database.model.impl.EmployeeModelImpl;
import employee.database.service.persistence.EmployeePersistence;
import employee.database.service.persistence.EmployeeUtil;
...
public class EmployeePersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindBypositionType;
	private FinderPath _finderPathWithoutPaginationFindBypositionType;
	private FinderPath _finderPathCountBypositionType;
	 ...
	 */
	@Override
	public List<Employee> findBypositionType(long position) {
		return findBypositionType(
	 ...
	 */
	@Override
	public List<Employee> findBypositionType(
		long position, int start, int end) {

		return findBypositionType(position, start, end, null);
	}
	...
	public List<Employee> findBypositionType(
		...
		return findBypositionType(
			position, start, end, orderByComparator, true);
	}
	...
	public List<Employee> findBypositionType(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindBypositionType;
				finderArgs = new Object[] {position};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindBypositionType;
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_POSITIONTYPE_POSITION_2);
	 ...
	 */
	@Override
	public Employee findBypositionType_First(
			long position, OrderByComparator<Employee> orderByComparator)
		throws NoSuchEmployeeException {

		Employee employee = fetchBypositionType_First(
	 ...
	 */
	@Override
	public Employee fetchBypositionType_First(
		long position, OrderByComparator<Employee> orderByComparator) {

		List<Employee> list = findBypositionType(
	 ...
	 */
	@Override
	public Employee findBypositionType_Last(
			long position, OrderByComparator<Employee> orderByComparator)
		throws NoSuchEmployeeException {

		Employee employee = fetchBypositionType_Last(
			position, orderByComparator);
	 ...
	 */
	@Override
	public Employee fetchBypositionType_Last(
		long position, OrderByComparator<Employee> orderByComparator) {

		int count = countBypositionType(position);
	 ...
	 */
	@Override
	public Employee[] findBypositionType_PrevAndNext(
		...
		try {
			...
			array[0] = getBypositionType_PrevAndNext(
				session, employee, position, orderByComparator, true);

			array[1] = employee;

			array[2] = getBypositionType_PrevAndNext(
				session, employee, position, orderByComparator, false);
	...
	protected Employee getBypositionType_PrevAndNext(
		Session session, Employee employee, long position,
		OrderByComparator<Employee> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public void removeBypositionType(long position) {
		for (Employee employee :
				findBypositionType(
					position, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
	 ...
	 */
	@Override
	public int countBypositionType(long position) {
		FinderPath finderPath = _finderPathCountBypositionType;
	...
	private static final String _FINDER_COLUMN_POSITIONTYPE_POSITION_2 =
		"employee.position = ?";
	...
	public void afterPropertiesSet() {
		Bundle bundle = FrameworkUtil.getBundle(EmployeePersistenceImpl.class);
		...
		_finderPathWithPaginationFindBypositionType = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findBypositionType",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"position"}, true);

		_finderPathWithoutPaginationFindBypositionType = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findBypositionType",
			new String[] {Long.class.getName()}, new String[] {"position"},
			true);

		_finderPathCountBypositionType = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countBypositionType",
			new String[] {Long.class.getName()}, new String[] {"position"},
			false);
